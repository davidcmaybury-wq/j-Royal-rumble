...
🤖 **Sometimes the computer hosts.** Two voices: **Mike** reads the clues and rules on them, **Gene** calls the ring — entrances, eliminations, overtime. The voice comes out of *your own buzzer*, so **turn your sound on** and click the page once so your browser will play it. The buzzers arm the moment Mike finishes reading. **Whoever has the board calls the next clue** — click it on the board in your buzzer window; leave it twelve seconds and Mike picks one for you.
