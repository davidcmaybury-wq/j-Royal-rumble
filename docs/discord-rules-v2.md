...
🤖 **Sometimes the computer hosts — this is brand new, treat it as an experiment.** Two voices: **Mike** reads the clues and rules on them, **Gene** calls the ring — entrances, eliminations, overtime. The voice comes out of *your own buzzer*, so **turn your sound on** and click the page once so your browser will play it. The buzzers arm the moment Mike finishes reading. **Whoever has the board calls the next clue** — say it ("presidents for four hundred") or click it; leave it twelve seconds and Mike picks one for you. **Win a buzz and just say your answer** — seven seconds, with a countdown on your buzzer, no question form needed, and "be more specific" earns you a second try instead of a miss. Chrome or Edge, and say yes to the mic; anything else and you click and answer on the call like always.
